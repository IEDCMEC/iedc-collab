...
const Mission = () => {
  return (
    <div className="mission_main">
      <div className="heading_mission" data-aos="fade-left" data-aos-duration="2000">OUR MISSION</div>
      <div className="paragraph_mission" data-aos="fade-left" data-aos-duration="2000">
