...
const NewProjectForm = ({ onClose }) => {
  const newProjectSchema = yup.object({
    ...
    contactNo: yup.string().required("Please add a valid phone number").min(10, "Must be more than 10 characters"),
    ...
    <div className='newProjectForm'>
      <Formik
        ...
        onSubmit={(values, actions) => {
          ...
          doCreateProject(values.title, values.desc, values.links, values.contactNo, values.githubLink, values.tags,);
          actions.resetForm();
          history.go(0);
          onClose();
        }}
        ...
        {(props) => (
          <Form>
            ...
            <InputGroup controlId='formPhoto' className="photoContainer">
              ...
              <Form.Label className="photoLabel"><i className="photoHead">Upload Featuring Photo</i>
              <i className="photoIcon"><FontAwesomeIcon icon={faUpload} /></i>
              <Form.Control
                required
